...
-- Dumping database structure for bhojonrestorentadd
CREATE DATABASE IF NOT EXISTS `bhojonrestorentadd` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `bhojonrestorentadd`;

-- Dumping structure for table bhojonrestorentadd.accesslog
...
-- Dumping data for table bhojonrestorentadd.accesslog: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.acc_account_name
...
-- Dumping data for table bhojonrestorentadd.acc_account_name: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.acc_coa
...
-- Dumping data for table bhojonrestorentadd.acc_coa: ~218 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.acc_customer_income
...
-- Dumping data for table bhojonrestorentadd.acc_customer_income: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.acc_glsummarybalance
...
-- Dumping data for table bhojonrestorentadd.acc_glsummarybalance: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.acc_income_expence
...
-- Dumping data for table bhojonrestorentadd.acc_income_expence: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.acc_temp
...
-- Dumping data for table bhojonrestorentadd.acc_temp: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.acc_transaction
...
-- Dumping data for table bhojonrestorentadd.acc_transaction: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.acn_account_transaction
...
-- Dumping data for table bhojonrestorentadd.acn_account_transaction: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.add_ons
...
-- Dumping data for table bhojonrestorentadd.add_ons: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.award
...
-- Dumping data for table bhojonrestorentadd.award: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.bank_summary
...
-- Dumping data for table bhojonrestorentadd.bank_summary: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.bill
...
-- Dumping data for table bhojonrestorentadd.bill: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.bill_card_payment
...
-- Dumping data for table bhojonrestorentadd.bill_card_payment: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.candidate_basic_info
...
-- Dumping data for table bhojonrestorentadd.candidate_basic_info: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.candidate_education_info
...
-- Dumping data for table bhojonrestorentadd.candidate_education_info: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.candidate_interview
...
-- Dumping data for table bhojonrestorentadd.candidate_interview: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.candidate_selection
...
-- Dumping data for table bhojonrestorentadd.candidate_selection: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.candidate_shortlist
...
-- Dumping data for table bhojonrestorentadd.candidate_shortlist: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.candidate_workexperience
...
-- Dumping data for table bhojonrestorentadd.candidate_workexperience: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.check_addones
...
-- Dumping data for table bhojonrestorentadd.check_addones: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.common_setting
...
-- Dumping data for table bhojonrestorentadd.common_setting: ~0 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.currency
...
-- Dumping data for table bhojonrestorentadd.currency: ~3 rows (approximately)
INSERT INTO `currency` (`currencyid`, `currencyname`, `curr_icon`, `position`, `curr_rate`) VALUES
	(1, 'BDT', 'BDT', 2, 83.00),
	(2, 'USD', '$', 1, 1.00),
	(3, 'INR', 'R', 1, 0.50);

-- Dumping structure for table bhojonrestorentadd.customer_info
...
-- Dumping data for table bhojonrestorentadd.customer_info: ~2 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.customer_membership_map
...
-- Dumping data for table bhojonrestorentadd.customer_membership_map: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.customer_order
...
-- Dumping data for table bhojonrestorentadd.customer_order: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.customer_type
...
-- Dumping data for table bhojonrestorentadd.customer_type: ~5 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.custom_table
...
-- Dumping data for table bhojonrestorentadd.custom_table: ~4 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.department
...
-- Dumping data for table bhojonrestorentadd.department: ~11 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.duty_type
...
-- Dumping data for table bhojonrestorentadd.duty_type: ~4 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.email_config
...
-- Dumping data for table bhojonrestorentadd.email_config: ~0 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.employee_benifit
...
-- Dumping data for table bhojonrestorentadd.employee_benifit: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.employee_history
...
-- Dumping data for table bhojonrestorentadd.employee_history: ~5 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.employee_performance
...
-- Dumping data for table bhojonrestorentadd.employee_performance: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.employee_salary_payment
...
-- Dumping data for table bhojonrestorentadd.employee_salary_payment: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.employee_salary_setup
...
-- Dumping data for table bhojonrestorentadd.employee_salary_setup: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.employee_sal_pay_type
...
-- Dumping data for table bhojonrestorentadd.employee_sal_pay_type: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.emp_attendance
...
-- Dumping data for table bhojonrestorentadd.emp_attendance: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.expense
...
-- Dumping data for table bhojonrestorentadd.expense: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.expense_item
...
-- Dumping data for table bhojonrestorentadd.expense_item: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.foodvariable
...
-- Dumping data for table bhojonrestorentadd.foodvariable: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.gender
...
-- Dumping data for table bhojonrestorentadd.gender: ~3 rows (approximately)
INSERT INTO `gender` (`id`, `gender_name`) VALUES
	(1, 'Male'),
	(2, 'Female'),
	(3, 'Other');

-- Dumping structure for table bhojonrestorentadd.grand_loan
...
-- Dumping data for table bhojonrestorentadd.grand_loan: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.ingredients
...
-- Dumping data for table bhojonrestorentadd.ingredients: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.item_category
...
-- Dumping data for table bhojonrestorentadd.item_category: 0 rows
/*!40000 ALTER TABLE `item_category` DISABLE KEYS */;
/*!40000 ALTER TABLE `item_category` ENABLE KEYS */;

-- Dumping structure for table bhojonrestorentadd.item_foods
...
-- Dumping data for table bhojonrestorentadd.item_foods: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.job_advertisement
...
-- Dumping data for table bhojonrestorentadd.job_advertisement: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.language
...
) ENGINE=InnoDB AUTO_INCREMENT=2340 DEFAULT CHARSET=utf8mb3;

-- Dumping data for table bhojonrestorentadd.language: ~1,493 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.leave_apply
...
-- Dumping data for table bhojonrestorentadd.leave_apply: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.leave_type
...
-- Dumping data for table bhojonrestorentadd.leave_type: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.loan_installment
...
-- Dumping data for table bhojonrestorentadd.loan_installment: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.marital_info
...
-- Dumping data for table bhojonrestorentadd.marital_info: ~5 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.membership
...
-- Dumping data for table bhojonrestorentadd.membership: ~3 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.menu_add_on
...
-- Dumping data for table bhojonrestorentadd.menu_add_on: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.message
...
-- Dumping data for table bhojonrestorentadd.message: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.module
...
-- Dumping data for table bhojonrestorentadd.module: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.module_permission
...
-- Dumping data for table bhojonrestorentadd.module_permission: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.module_purchase_key
CREATE TABLE IF NOT EXISTS `module_purchase_key` (
  `id` int NOT NULL AUTO_INCREMENT,
  `identity` varchar(250) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `purchase_key` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;

-- Dumping data for table bhojonrestorentadd.module_purchase_key: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.multipay_bill
CREATE TABLE IF NOT EXISTS `multipay_bill` (
  `multipay_id` int NOT NULL AUTO_INCREMENT,
  `order_id` int NOT NULL,
  `multipayid` varchar(30) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `payment_type_id` int NOT NULL,
  `amount` float NOT NULL,
  PRIMARY KEY (`multipay_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;

-- Dumping data for table bhojonrestorentadd.multipay_bill: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.order_menu
...
-- Dumping data for table bhojonrestorentadd.order_menu: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.paymentsetup
...
-- Dumping data for table bhojonrestorentadd.paymentsetup: ~11 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.payment_method
...
-- Dumping data for table bhojonrestorentadd.payment_method: ~13 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.payroll_commission_setting
...
-- Dumping data for table bhojonrestorentadd.payroll_commission_setting: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.payroll_holiday
...
-- Dumping data for table bhojonrestorentadd.payroll_holiday: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.payroll_tax_setup
...
-- Dumping data for table bhojonrestorentadd.payroll_tax_setup: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.pay_frequency
...
-- Dumping data for table bhojonrestorentadd.pay_frequency: ~4 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.position
...
-- Dumping data for table bhojonrestorentadd.position: ~7 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.production
...
-- Dumping data for table bhojonrestorentadd.production: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.production_details
...
-- Dumping data for table bhojonrestorentadd.production_details: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.purchaseitem
...
-- Dumping data for table bhojonrestorentadd.purchaseitem: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.purchase_details
...
-- Dumping data for table bhojonrestorentadd.purchase_details: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.purchase_return
...
-- Dumping data for table bhojonrestorentadd.purchase_return: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.purchase_return_details
...
-- Dumping data for table bhojonrestorentadd.purchase_return_details: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.rate_type
...
-- Dumping data for table bhojonrestorentadd.rate_type: ~2 rows (approximately)
INSERT INTO `rate_type` (`id`, `r_type_name`) VALUES
	(1, 'Hourly'),
	(2, 'Salary');

-- Dumping structure for table bhojonrestorentadd.reservationofday
...
-- Dumping data for table bhojonrestorentadd.reservationofday: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.rest_table
...
-- Dumping data for table bhojonrestorentadd.rest_table: ~8 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.role_permission
...
-- Dumping data for table bhojonrestorentadd.role_permission: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.salary_setup_header
...
-- Dumping data for table bhojonrestorentadd.salary_setup_header: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.salary_sheet_generate
...
-- Dumping data for table bhojonrestorentadd.salary_sheet_generate: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.salary_type
...
-- Dumping data for table bhojonrestorentadd.salary_type: ~2 rows (approximately)
INSERT INTO `salary_type` (`salary_type_id`, `sal_name`, `emp_sal_type`, `default_amount`, `status`) VALUES
	(1, 'House Rent', '1', '', ''),
	(2, 'Medical', '1', '', '');

-- Dumping structure for table bhojonrestorentadd.sec_menu_item
...
-- Dumping data for table bhojonrestorentadd.sec_menu_item: ~164 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.sec_role_permission
...
-- Dumping data for table bhojonrestorentadd.sec_role_permission: ~176 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.sec_role_tbl
...
-- Dumping data for table bhojonrestorentadd.sec_role_tbl: ~3 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.sec_user_access_tbl
...
-- Dumping data for table bhojonrestorentadd.sec_user_access_tbl: ~0 rows (approximately)
INSERT INTO `sec_user_access_tbl` (`role_acc_id`, `fk_role_id`, `fk_user_id`) VALUES
	(1, 3, 172);

-- Dumping structure for table bhojonrestorentadd.setting
...
-- Dumping data for table bhojonrestorentadd.setting: ~0 rows (approximately)
INSERT INTO `setting` (`id`, `title`, `storename`, `address`, `email`, `phone`, `logo`, `logoweb`, `favicon`, `opentime`, `closetime`, `vat`, `isvatnumshow`, `vattinno`, `isvatinclusive`, `discount_type`, `discountrate`, `servicecharge`, `service_chargeType`, `currency`, `min_prepare_time`, `language`, `timezone`, `dateformat`, `site_align`, `kitchenrefreshtime`, `powerbytxt`, `footer_text`, `reservation_open`, `reservation_close`, `maxreserveperson`, `printtype`) VALUES
	(2, 'Bhojon Restaurant', 'Dhaka Restaurant', '98 Green Road, Farmgate, Dhaka-1215.', 'bdtask@gmail.com', '0123456789', 'assets/img/icons/2019-10-29/h.png', NULL, 'assets/img/icons/m.png', '9:00AM', '10:00PM', 7.50, NULL, '23457586', 1, 1, 5.000, 20, 1, 2, '1:00 Hour', 'english', 'Asia/Dhaka', 'd/m/Y', 'LTR', 15, 'Powered By: BDTASK, www.bdtask.com\r\n', '2020', '09:00:00', '22:00:00', 20, 2);

-- Dumping structure for table bhojonrestorentadd.shipping_method
...
-- Dumping data for table bhojonrestorentadd.shipping_method: ~3 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.sms_configuration
...
-- Dumping data for table bhojonrestorentadd.sms_configuration: ~3 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.sms_template
...
-- Dumping data for table bhojonrestorentadd.sms_template: ~4 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.subscribe_emaillist
...
-- Dumping data for table bhojonrestorentadd.subscribe_emaillist: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.sub_order
CREATE TABLE IF NOT EXISTS `sub_order` (
  ...
  `order_menu_id` text COLLATE utf8mb3_unicode_ci,
  `adons_id` varchar(20) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `adons_qty` varchar(20) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `invoiceprint` int DEFAULT NULL,
  PRIMARY KEY (`sub_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;

-- Dumping data for table bhojonrestorentadd.sub_order: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.supplier
...
-- Dumping data for table bhojonrestorentadd.supplier: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.supplier_ledger
...
-- Dumping data for table bhojonrestorentadd.supplier_ledger: 0 rows
/*!40000 ALTER TABLE `supplier_ledger` DISABLE KEYS */;
/*!40000 ALTER TABLE `supplier_ledger` ENABLE KEYS */;

-- Dumping structure for table bhojonrestorentadd.synchronizer_setting
...
-- Dumping data for table bhojonrestorentadd.synchronizer_setting: ~0 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.table_details
...
-- Dumping data for table bhojonrestorentadd.table_details: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.table_setting
...
-- Dumping data for table bhojonrestorentadd.table_setting: ~10 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.tblreservation
...
-- Dumping data for table bhojonrestorentadd.tblreservation: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.tblserver
...
-- Dumping data for table bhojonrestorentadd.tblserver: ~0 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.tbl_assign_kitchen
...
-- Dumping data for table bhojonrestorentadd.tbl_assign_kitchen: ~0 rows (approximately)
INSERT INTO `tbl_assign_kitchen` (`assignid`, `kitchen_id`, `userid`) VALUES
	(2, 1, 177);

-- Dumping structure for table bhojonrestorentadd.tbl_bank
...
-- Dumping data for table bhojonrestorentadd.tbl_bank: ~3 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.tbl_billingaddress
...
-- Dumping data for table bhojonrestorentadd.tbl_billingaddress: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.tbl_cancelitem
...
-- Dumping data for table bhojonrestorentadd.tbl_cancelitem: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.tbl_card_terminal
...
-- Dumping data for table bhojonrestorentadd.tbl_card_terminal: ~3 rows (approximately)
INSERT INTO `tbl_card_terminal` (`card_terminalid`, `terminal_name`) VALUES
	(1, 'Nexus Terminal'),
	(2, 'Brac Bank Terminal'),
	(3, 'Visa-Master Terminal');

-- Dumping structure for table bhojonrestorentadd.tbl_cashcounter
...
-- Dumping data for table bhojonrestorentadd.tbl_cashcounter: ~2 rows (approximately)
INSERT INTO `tbl_cashcounter` (`ccid`, `counterno`) VALUES
	(1, 1),
	(2, 2);

-- Dumping structure for table bhojonrestorentadd.tbl_cashregister
...
-- Dumping data for table bhojonrestorentadd.tbl_cashregister: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.tbl_city
...
-- Dumping data for table bhojonrestorentadd.tbl_city: ~3 rows (approximately)
INSERT INTO `tbl_city` (`cityid`, `countryid`, `stateid`, `cityname`, `status`) VALUES
	(3, 1, 12, 'Savar', 1),
	(4, 1, 12, 'Gajipur', 1),
	(5, 1, 12, 'Mirpur', 1);

-- Dumping structure for table bhojonrestorentadd.tbl_country
...
-- Dumping data for table bhojonrestorentadd.tbl_country: ~5 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.tbl_delivaritime
...
-- Dumping data for table bhojonrestorentadd.tbl_delivaritime: ~22 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.tbl_delivaryaddress
...
-- Dumping data for table bhojonrestorentadd.tbl_delivaryaddress: ~21 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.tbl_generatedreport
...
-- Dumping data for table bhojonrestorentadd.tbl_generatedreport: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.tbl_groupitems
...
-- Dumping data for table bhojonrestorentadd.tbl_groupitems: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.tbl_itemaccepted
...
-- Dumping data for table bhojonrestorentadd.tbl_itemaccepted: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.tbl_kitchen
...
-- Dumping data for table bhojonrestorentadd.tbl_kitchen: ~0 rows (approximately)
INSERT INTO `tbl_kitchen` (`kitchenid`, `kitchen_name`, `ip`, `port`, `status`) VALUES
	(1, 'Common Kitchen', '192.168.1.87', '9100', 1);

-- Dumping structure for table bhojonrestorentadd.tbl_kitchen_order
...
-- Dumping data for table bhojonrestorentadd.tbl_kitchen_order: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.tbl_menutype
...
-- Dumping data for table bhojonrestorentadd.tbl_menutype: ~5 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.tbl_module_purchasekey
...
-- Dumping data for table bhojonrestorentadd.tbl_module_purchasekey: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.tbl_notificationsetting
...
-- Dumping data for table bhojonrestorentadd.tbl_notificationsetting: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.tbl_openclose
...
-- Dumping data for table bhojonrestorentadd.tbl_openclose: ~7 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.tbl_orderprepare
...
-- Dumping data for table bhojonrestorentadd.tbl_orderprepare: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.tbl_posetting
...
-- Dumping data for table bhojonrestorentadd.tbl_posetting: ~0 rows (approximately)
INSERT INTO `tbl_posetting` (`possettingid`, `waiter`, `tableid`, `cooktime`, `productionsetting`, `tablemaping`, `soundenable`) VALUES
	(1, 1, 1, 1, 0, 1, 0);

-- Dumping structure for table bhojonrestorentadd.tbl_quickordersetting
...
-- Dumping data for table bhojonrestorentadd.tbl_quickordersetting: ~0 rows (approximately)
INSERT INTO `tbl_quickordersetting` (`quickordid`, `waiter`, `tableid`, `cooktime`, `soundenable`, `tablemaping`) VALUES
	(1, 1, 1, 1, 0, 1);

-- Dumping structure for table bhojonrestorentadd.tbl_rating
...
-- Dumping data for table bhojonrestorentadd.tbl_rating: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.tbl_room
...
-- Dumping data for table bhojonrestorentadd.tbl_room: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.tbl_seoption
...
-- Dumping data for table bhojonrestorentadd.tbl_seoption: ~18 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.tbl_shippingaddress
...
-- Dumping data for table bhojonrestorentadd.tbl_shippingaddress: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.tbl_slider
...
-- Dumping data for table bhojonrestorentadd.tbl_slider: ~20 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.tbl_slider_type
...
-- Dumping data for table bhojonrestorentadd.tbl_slider_type: ~10 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.tbl_sociallink
...
-- Dumping data for table bhojonrestorentadd.tbl_sociallink: ~5 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.tbl_soundsetting
...
-- Dumping data for table bhojonrestorentadd.tbl_soundsetting: ~0 rows (approximately)
INSERT INTO `tbl_soundsetting` (`soundid`, `nofitysound`, `addtocartsound`) VALUES
	(1, 'assets/2021-03-21/b1.mp3', 'h');

-- Dumping structure for table bhojonrestorentadd.tbl_state
...
-- Dumping data for table bhojonrestorentadd.tbl_state: ~31 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.tbl_tablefloor
...
-- Dumping data for table bhojonrestorentadd.tbl_tablefloor: ~3 rows (approximately)
INSERT INTO `tbl_tablefloor` (`tbfloorid`, `floorName`) VALUES
	(1, 'First Floor'),
	(2, 'VIP Floor'),
	(3, 'Second Floor');

-- Dumping structure for table bhojonrestorentadd.tbl_thirdparty_customer
...
-- Dumping data for table bhojonrestorentadd.tbl_thirdparty_customer: ~4 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.tbl_token
...
-- Dumping data for table bhojonrestorentadd.tbl_token: ~0 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.tbl_updateitems
...
-- Dumping data for table bhojonrestorentadd.tbl_updateitems: 0 rows
/*!40000 ALTER TABLE `tbl_updateitems` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_updateitems` ENABLE KEYS */;

-- Dumping structure for table bhojonrestorentadd.tbl_version_checker
...
-- Dumping data for table bhojonrestorentadd.tbl_version_checker: ~0 rows (approximately)
INSERT INTO `tbl_version_checker` (`vid`, `version`, `disable`) VALUES
	(1, '2.8', 0);

-- Dumping structure for table bhojonrestorentadd.tbl_waiterappcart
...
-- Dumping data for table bhojonrestorentadd.tbl_waiterappcart: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.tbl_widget
...
-- Dumping data for table bhojonrestorentadd.tbl_widget: ~20 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.themes
...
-- Dumping data for table bhojonrestorentadd.themes: ~2 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.top_menu
...
-- Dumping data for table bhojonrestorentadd.top_menu: ~10 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.unit_of_measurement
...
-- Dumping data for table bhojonrestorentadd.unit_of_measurement: ~11 rows (approximately)
...
-- Dumping structure for table bhojonrestorentadd.usedcoupon
...
-- Dumping data for table bhojonrestorentadd.usedcoupon: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.user
...
-- Dumping data for table bhojonrestorentadd.user: ~6 rows (approximately)
INSERT INTO `user` (`id`, `firstname`, `lastname`, `about`, `waiter_kitchenToken`, `email`, `password`, `password_reset_token`, `image`, `last_login`, `last_logout`, `ip_address`, `counter`, `status`, `is_admin`) VALUES
	...
	(179, NULL, NULL, NULL, NULL, 'mhdafjalit@gmail.com', '25d55ad283aa400af464c76d713c07ad', NULL, NULL, '2024-12-14 03:15:31', NULL, '::1', NULL, 1, 1);

-- Dumping structure for table bhojonrestorentadd.variant
...
-- Dumping data for table bhojonrestorentadd.variant: ~0 rows (approximately)

-- Dumping structure for table bhojonrestorentadd.weekly_holiday
...
-- Dumping data for table bhojonrestorentadd.weekly_holiday: ~1 rows (approximately)
